...
namespace FWW.Framework.EncryptUI.Common
{
    /// <summary>
    /// 
    /// </summary>
    public class EncryptHelper
    {
        ...
        static EncryptHelper()
        {
            ...
            {
                encryKey +=Convert.ToString((item + 1));
            }
            EncryKey = encryKey.Substring(0,8);
        }
        public static string EncrypConnectionstring(string password)
        {
            return EncryptDES(password, EncryKey);
        }
        /// <summary>  
        /// MD5加密不区分大小写的  
        /// </summary>  
