...
namespace FWW.Framework.DapperEx
{
    ...
    {
        public string LastSqlExpress { get; internal set; }
        public object LastSqlParameters { get; internal set; }
        ...
        /// <returns></returns>
        internal DbCommand AddCommandParameter(DbCommand command, SqlDataParameter parameters)
        {
            if (null == parameters || parameters.Any() == false)
                return command;
            ...
            {
                DbParameter dbParameter = CreateParameter(p.Key);
