...
{
    public class WhereClipEx<T> : WhereClip
    {
    ...
    public class WhereClip : Expression
    {
        ...
        public WhereClip(string customWhereString, SqlDataParameter parameters)
        ...
        public static bool Equals(WhereClip leftWhere, WhereClip rightWhere)
        {
            ...
            foreach (var p in leftWhere.parameters)
            {
                leftWhereString.Replace(p.Key, (p.Value== null) ? string.Empty : p.Value.ToString());
            }

            foreach (var p in rightWhere.parameters)
            {
                rightWhereString.Replace(p.Key, (p.Value == null) ? string.Empty : p.Value.ToString());
            }
        ...
        public static WhereClip operator !(WhereClip where)
        {
            ...
            return new WhereClip(string.Concat(" NOT ", where.expressionString), where.parameters);
        }
        ...
        {
            return new WhereClip(string.Concat(" EXISTS (", fromSection.SqlString, ") "), fromSection.Parameters);
        }
