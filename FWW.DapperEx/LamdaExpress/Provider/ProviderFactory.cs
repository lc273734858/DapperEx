...
namespace FWW.Framework.DapperEx
{
    ...
    public sealed class ProviderFactory
    {
        ...
        public static DbProvider CreateDbProvider(string assemblyName, string className, string connectionString, DatabaseType? databaseType)
        {
            ...
            else if (String.Compare(className, "System.Data.SqlClient", StringComparison.OrdinalIgnoreCase) == 0 || String.Compare(className, "FWW.Framework.DapperEx.SqlServer", StringComparison.OrdinalIgnoreCase) == 0)
            {
                className = typeof(SqlServer.SqlServerProvider).ToString();
                if (databaseType == null)
                {
            ...
            {
                className = "FWW.Framework.DapperEx.MySql.MySqlProvider";
                assemblyName = "FWW.Framework.DapperEx.MySql";
                if (databaseType == null)
                {
            ...
            {
                className = "FWW.Framework.DapperEx.Sqlite.SqliteProvider";
                assemblyName = "FWW.Framework.DapperEx.Sqlite";
                if (databaseType == null)
                {
        ...
        {
            Check.NotNullOrEmpty(connStrName, "connStrName");
