...
namespace FWW.Framework.DapperEx
{
    ...
    public class DataUtils
    {
        ...
        public static string MakeUniqueKey(Field field)//string prefix,
        {
            ...
            //TODO 此处应该根据数据库类型来附加@、?、:
            //2015-08-10，去掉了第一个"@", 
            var key= string.Concat(field.tableName, "_", field.Name, "_", GetNewParamCount());
            return string.Concat("@",key.Replace(".","").Replace("[","").Replace("]",""));
    ...
    public static class DosORMCommonExpand
    {
        ...
        /// <param name="inherit"></param>
        /// <returns></returns>
        public static TAttribute GetCustomAttribute<TAttribute>(this MemberInfo member, Boolean inherit) where TAttribute:Attribute
        {
            var atts = member.GetCustomAttributes(typeof(TAttribute),inherit);
