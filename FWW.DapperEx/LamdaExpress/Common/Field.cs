    ...
    public class Field
    {
        ...
        public string FullName
        {
            get
            {
                ...
                return string.Concat(TableFieldName, " AS ", aliasName);
            }
        }
        ...
        private WhereClip selectInOrNotIn<T>(Field field, string join, bool isParameter, params T[] values)
        {
            ...
            whereString.Append("(");
            SqlDataParameter ps = new SqlDataParameter();
            ...
            return new WhereClip(whereString.ToString(), ps);
        }
        ...
        {
            return new WhereClip(this, values, QueryOperator.In);
        ...
        {
            return new WhereClip(this, values, QueryOperator.NotIn);
        ...
        private WhereClip subQuery(Field field, FromSection from, string join)
        {
            ...
            {
                return new WhereClip(string.Concat(field.TableFieldName, join, "(SELECT * FROM (", from.getPagedFromSection().SqlString, ") AS TEMP" + DataUtils.GetNewParamCount() + ")"), from.Parameters);
            }
            return new WhereClip(string.Concat(field.TableFieldName, join, "(", from.getPagedFromSection().SqlString, ")"), from.Parameters);
        }
