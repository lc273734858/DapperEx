...
namespace FWW.Framework.DapperEx
{
    ...
    static partial class SqlMapper
    {
        ...
        {
            //lock (_queryCache) { return _queryCache.TryGetValue(key, out value); } 去掉读取字典时的
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        public static IEnumerable<object> QueryObject(this IDbConnection cnn, string sql, object param, string typename)
        {
            return QueryObject(cnn, sql, param, null, true, null, null, typename);
        }
        /// <summary>
        /// Return a list of dynamic objects, reader is closed after the call
        /// </summary>
        ...
        public static IEnumerable<object> QueryObject(this IDbConnection cnn, string sql, object param, string typename, IDbTransaction transaction)
        {
            return QueryObject(cnn, sql, param, transaction, true, null, null, typename);
        }
        ...
        public static IEnumerable<object> QueryObject(this IDbConnection cnn, string sql, object param, string typename, CommandType? commandType)
        {
            return QueryObject(cnn, sql, param, null, true, null, commandType, typename);
        }
        ...
        public static IEnumerable<object> QueryObject(this IDbConnection cnn, string sql, object param, string typename, IDbTransaction transaction, CommandType? commandType)
        {
            return QueryObject(cnn, sql, param, transaction, true, null, commandType, typename);
        }
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
        ...
        public static IEnumerable<object> QueryObject(this IDbConnection cnn, string sql, object param, IDbTransaction transaction, bool buffered, int? commandTimeout, CommandType? commandType, string typename)
        {
            var command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, buffered ? CommandFlags.Buffered : CommandFlags.None);
            var data = QueryImplObject(cnn, command, Type.GetType(typename));
            return command.Buffered ? data.ToList() : data;
        }
        #region DataTable
        public static DataTable QueryDataTable(this IDbConnection cnn, string sql, object param, IDbTransaction transaction, bool buffered, int? commandTimeout, CommandType? commandType, Type effectiveType)
        {
            var command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, buffered ? CommandFlags.Buffered : CommandFlags.None);
            var data = QueryDataTable(cnn, command, effectiveType);
            return data;
        }
        public static DataTable QueryDataTable(this IDbConnection cnn, string sql, object param, Type effectiveType)
        {
            return QueryDataTable(cnn, sql, param, null, true, null, null, effectiveType);
        }
        public static DataTable QueryDataTable(this IDbConnection cnn, string sql, object param, Type effectiveType, CommandType? commandType)
        {
            return QueryDataTable(cnn, sql, param, null, true, null, commandType, effectiveType);
        }
        public static DataTable QueryDataTable(this IDbConnection cnn, string sql, object param, Type effectiveType, IDbTransaction transaction)
        {
            return QueryDataTable(cnn, sql, param, transaction, true, null, null, effectiveType);
        }
        public static DataTable QueryDataTable(this IDbConnection cnn, string sql, object param, Type effectiveType, IDbTransaction transaction, CommandType? commandType)
        {
            return QueryDataTable(cnn, sql, param, transaction, true, null, commandType, effectiveType);
        }
        #endregion
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        private static IEnumerable<object> QueryImplObject(this IDbConnection cnn, CommandDefinition command, Type effectiveType)
        {
            object param = command.Parameters;
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        yield return Convert.ChangeType(val, convertToType, CultureInfo.InvariantCulture);
                    }
                }
        ...
        private static DataTable QueryDataTable(this IDbConnection cnn, CommandDefinition command, Type effectiveType)
        {
            object param = command.Parameters;
            var identity = new Identity(command.CommandText, command.CommandType, cnn, effectiveType, param == null ? null : param.GetType(), null);
            var info = GetCacheInfo(identity, param, command.AddToCache);
...
#pragma warning restore 612, 618
    ...
    sealed class DataTableHandler : FWW.Framework.DapperEx.SqlMapper.ITypeHandler
    {
    ...
    /// Used to pass a DataTable as a TableValuedParameter
    /// </summary>
    sealed partial class TableValuedParameter : FWW.Framework.DapperEx.SqlMapper.ICustomQueryParameter
    {
    ...
    /// </summary>
    sealed partial class DbString : FWW.Framework.DapperEx.SqlMapper.ICustomQueryParameter
    {
        /// <summary>
    ...
    public partial class SqlMapper
    {
        ...
        public static void Insert(this IDbConnection cnn, object model, IDbTransaction tran = null)
        {
            var sql=EntityCache.CreateInsertSQL(model);
            Execute(cnn, sql, model,tran);
        }
        /// <summary>
        /// 返回自增列
        /// </summary>
        /// <param name="cnn"></param>
        /// <param name="model"></param>
        public static int InsertAutoIncrement(this IDbConnection cnn, object model, IDbTransaction tran = null)
        {
            var sql = EntityCache.CreateInsertSQL(model);
            return ExecuteScalar<int>(cnn, sql, model, tran, null, null);            
        }
        /// <summary>
        /// 根据主键作为条件更新实体
        /// </summary>
        ...
        public static int UpdateByPrimaryKey(this IDbConnection cnn, object model, string extendUpSql = "", IDbTransaction tran = null)
        {
            var sql=EntityCache.CreateUpdateByPrimaryKey(model, extendUpSql);            
            return Execute(cnn, sql, model,tran);
        }
        /// <summary>
        ...
        /// <returns>System.Int32.</returns>
        public static int UpdateByWhere(this IDbConnection cnn, object model, string where, string extendUpSql = "", IDbTransaction tran = null)
        {
            SqlDataParameter para = new SqlDataParameter();
            var sql = EntityCache.CreateUpdateByWhere(model, where, extendUpSql);
            return Execute(cnn, sql, model,tran);
        }
        /// <summary>
        /// 
        ...
        /// <returns></returns>
        static public bool TryGetEntityByPrimaryKey<T>(this IDbConnection cnn, ref T model, string displayFields = "*", bool withnolock = true, IDbTransaction tran = null)
        {
            var sql=EntityCache.CreateSelectByPrimaryKey(model, displayFields, withnolock);
            var result=cnn.Query<T>(sql, model,tran);
            if (result.Any())
            {
        ...
        static public bool TryGetEntity<T>(this IDbConnection cnn, ref T model, string displayFields = "*", bool withnolock = true, IDbTransaction tran = null, string sort = "")
        {
            var sql = EntityCache.CreateSelectSimple(model, displayFields, sort, 1, withnolock);
            var result = cnn.Query<T>(sql, model, tran);
            if (result.Any())
            {
                model = result.FirstOrDefault();
        ...
        static public int DeleteByPrimaryKey(this IDbConnection cnn,object model,IDbTransaction tran=null)
        {
            var sql = EntityCache.CreateDeleteByPrimaryKey(model);
            return Execute(cnn, sql, model, tran);
        }
        static public int Delete(this IDbConnection cnn, Type model, WhereObjectList where, IDbTransaction tran = null)
        {
            var p = new SqlDataParameter();
            var sql = EntityCache.CreateDeleteSQL(model,where,ref p);
            return Execute(cnn, sql, p,tran);
        }
        static public int Delete(this IDbConnection cnn, Type model, string where, IDbTransaction tran = null)
        {
            var p = new SqlDataParameter();
